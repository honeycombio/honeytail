...
func GetSampledEntries(conf Config, sampleRate uint, abort chan bool) ([]chan string, error) {
...
func GetEntries(conf Config, abort chan bool) ([]chan string, error) {
...
func tailSingleFile(tailer *tail.Tail, file string, stateFile string, abort chan bool) chan string {
...
func tailStdIn(abort chan bool) chan string {
	lines := make(chan string)
